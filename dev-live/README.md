...
- Baseline: copied from root `3.0.0-livefix14` and relabeled as `3.0.0-devlive20`.
- Current validation build: `3.0.0-devlive21`.
...
## Offline Browser Smoke Check

Run against a local static server:

```powershell
& "C:\Users\antho\.cache\codex-runtimes\codex-primary-runtime\dependencies\node\bin\node.exe" .\dev-live\offline-smoke.mjs --base http://127.0.0.1:8765/dev-live/
```

Run against GitHub Pages after pushing:

```powershell
& "C:\Users\antho\.cache\codex-runtimes\codex-primary-runtime\dependencies\node\bin\node.exe" .\dev-live\offline-smoke.mjs --base https://bcocalc.github.io/dev-live/
```
