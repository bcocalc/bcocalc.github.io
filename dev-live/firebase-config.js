...
window.TAPCALC_BUILD = Object.assign({
  channel: 'dev-live',
  version: '3.0.0-devlive7',
  label: 'TapCalc Dev-Live v3.0.0-devlive7 - 2026-07-06',
  overlayVersion: '3.0.0-devlive7',
  serviceWorkerVersion: '3.0.0-devlive7',
  syncPill: 'DEV-LIVE'
}, window.TAPCALC_BUILD || {});

(function(){
  const BUILD = window.TAPCALC_BUILD || {};
  const VERSION = BUILD.overlayVersion || BUILD.version || '3.0.0-devlive7';
  const OVERLAYS = [
