const CACHE_NAME = 'tapcalc-cache-3.0.0-livefix19';
...
const ASSETS = [
  ...
  './styles.css?v=3.0.0-livefix19',
  './measurement.js?v=3.0.0-livefix19',
  './cloud-sync.js?v=3.0.0-livefix19',
  './tapcalc-overlays.css?v=3.0.0-livefix19',
  './tapcalc-overlays.js?v=3.0.0-livefix19',
  './overlays/tapcalc-workflow-library.css?v=3.0.0-livefix19',
  './overlays/tapcalc-workflow-library.js?v=3.0.0-livefix19',
  './overlays/tapcalc-livefix11-workflow.css?v=3.0.0-livefix19',
  './overlays/tapcalc-livefix11-workflow.js?v=3.0.0-livefix19',
  './overlays/tapcalc-shell-reference.css?v=3.0.0-livefix19',
  './overlays/tapcalc-shell-reference.js?v=3.0.0-livefix19',
  './overlays/tapcalc-field-manual.js?v=3.0.0-livefix19',
  './overlays/tapcalc-field-manual-mobile.css?v=3.0.0-livefix19',
  './overlays/tapcalc-light-mode.css?v=3.0.0-livefix19',
  './overlays/tapcalc-reference-router.css?v=3.0.0-livefix19',
  './overlays/tapcalc-reference-router.js?v=3.0.0-livefix19',
  './overlays/tapcalc-mobile-reliability.css?v=3.0.0-livefix19',
  './overlays/tapcalc-mobile-reliability.js?v=3.0.0-livefix19',
  './pdf.mjs?v=3.0.0-livefix19',
  './pdf.worker.mjs?v=3.0.0-livefix19',
  './stackup-data.js?v=3.0.0-livefix19',
  './manifest.json',
  './firebase-config.js?v=3.0.0-livefix19',
  './team-logo.png'
];
