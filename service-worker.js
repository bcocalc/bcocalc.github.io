const CACHE_NAME = 'tapcalc-cache-3.0.0-livefix10';
const ASSETS = [
  "./",
  "./index.html",
  "./measurement-card.html",
  "./styles.css?v=3.0.0-livefix10",
  "./measurement.js?v=3.0.0-livefix10",
  "./tapcalc-overlays.css?v=3.0.0-livefix10",
  "./tapcalc-overlays.js?v=3.0.0-livefix10",
  "./overlays/tapcalc-workflow-library.css?v=3.0.0-livefix10",
  "./overlays/tapcalc-workflow-library.js?v=3.0.0-livefix10",
  "./overlays/tapcalc-shell-reference.css?v=3.0.0-livefix10",
  "./overlays/tapcalc-shell-reference.js?v=3.0.0-livefix10",
  "./overlays/tapcalc-field-manual.js?v=3.0.0-livefix10",
  "./overlays/tapcalc-field-manual-mobile.css?v=3.0.0-livefix10",
  "./overlays/tapcalc-light-mode.css?v=3.0.0-livefix10",
  "./overlays/tapcalc-reference-router.css?v=3.0.0-livefix10",
  "./overlays/tapcalc-reference-router.js?v=3.0.0-livefix10",
  "./pdf.mjs?v=3.0.0-livefix10",
  "./pdf.worker.mjs?v=3.0.0-livefix10",
  "./stackup-data.js?v=3.0.0-livefix10",
  "./script.js",
  "./manifest.json",
  "./firebase-config.js?v=3.0.0-livefix10",
  "./team-logo.png"
];
