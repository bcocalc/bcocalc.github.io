const BUILD_VERSION = '3.0.0-alpha244';
...
const STACKUP_PDFJS_URL = './pdf.mjs?v=3.0.0-alpha244';
const STACKUP_PDFJS_WORKER_URL = './pdf.worker.mjs?v=3.0.0-alpha244';
...
navigator.serviceWorker.register('service-worker.js?v=3.0.0-alpha244', { updateViaCache: 'none' }).then((registration) => registration.update()).catch(() => {});
  });
}
...
/* ===== 3.0.0-alpha244 auto-scroll guard ===== */
(function(){
...
(function(){
const TC63_VERSION = '3.0.0-alpha244';
...
/* ===== 3.0.0-alpha244 shared library row consistency ===== */
(function(){
  const $ = (id) => document.getElementById(id);
