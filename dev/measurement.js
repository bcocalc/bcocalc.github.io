const BUILD_VERSION = '3.0.0-alpha141';
...
if ('serviceWorker' in navigator) {
  ...
  navigator.serviceWorker.register('service-worker.js?v=3.0.0-alpha141', { updateViaCache: 'none' }).then((registration) => registration.update()).catch(() => {});
  });
}
...
(function(){
  const TC63_VERSION = '3.0.0-alpha141';
