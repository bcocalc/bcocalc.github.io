...
window.TAPCALC_BUILD = Object.assign({
  channel: 'dev',
  version: '3.0.0-alpha214',
  label: 'TapCalc Dev v3.0.0-alpha214 - 2026-05-17',
  overlayVersion: '3.0.0-alpha214',
  serviceWorkerVersion: '3.0.0-alpha214',
  syncPill: 'DEV'
}, window.TAPCALC_BUILD || {});

(function(){
  const BUILD = window.TAPCALC_BUILD || {};
  const VERSION = BUILD.overlayVersion || BUILD.version || '3.0.0-alpha214';
  const OVERLAYS = [
