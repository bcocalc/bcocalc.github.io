...
window.TAPCALC_BUILD = Object.assign({
  channel: 'dev',
  version: '3.0.0-alpha226',
  label: 'TapCalc Dev v3.0.0-alpha226 - 2026-05-17',
  overlayVersion: '3.0.0-alpha226',
  serviceWorkerVersion: '3.0.0-alpha226',
  syncPill: 'DEV'
}, window.TAPCALC_BUILD || {});

(function(){
  const BUILD = window.TAPCALC_BUILD || {};
  const VERSION = BUILD.overlayVersion || BUILD.version || '3.0.0-alpha226';
  const OVERLAYS = [
