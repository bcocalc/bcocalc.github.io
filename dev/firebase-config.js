...
window.TAPCALC_BUILD = Object.assign({
  channel: 'dev',
  version: '3.0.0-alpha262',
  label: 'TapCalc Dev v3.0.0-alpha262 - 2026-09-12',
  overlayVersion: '3.0.0-alpha262',
  serviceWorkerVersion: '3.0.0-alpha262',
  syncPill: 'DEV'
}, window.TAPCALC_BUILD || {});

(function(){
  const BUILD = window.TAPCALC_BUILD || {};
  const VERSION = BUILD.overlayVersion || BUILD.version || '3.0.0-alpha262';
  const OVERLAYS = [
