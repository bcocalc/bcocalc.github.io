...
alpha258. Do not reuse the normal plug-installation start field or equations for
the connected measurement without confirming the reference and required math.
